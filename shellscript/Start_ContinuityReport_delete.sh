...
begin
    ...
    delete
        ...
        where
            to_date(firco_cty_report.generated, 'yyyy-mm-dd hh24:mi:ss') < reference_date;
    delete 
        from 
        ...
        where
            report_id in (
                select id 
                from ofac.firco_cty_report 
                where to_date(firco_cty_report.generated, 'yyyy-mm-dd hh24:mi:ss') < reference_date
            );
    commit;
end;
/
